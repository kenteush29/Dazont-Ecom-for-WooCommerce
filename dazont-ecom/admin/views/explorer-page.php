			...
			<?php foreach ( $dze_rows as $r ) :
				...
				<div class="dze-x-row" role="button" tabindex="0"
					...
					<span class="dze-x-row-act">
						...
						<button type="button" class="button button-small dze-x-mark" data-cat="<?php echo (int) $n['id']; ?>" title="<?php esc_attr_e( 'Mark novelty search done today', 'dazont-ecom' ); ?>"><?php esc_html_e( 'Mark as searched', 'dazont-ecom' ); ?></button>
					</span>
				</div>
			<?php endforeach; ?>
		</div>
