...
final class DZE_Cleanup {
	...
	public static function map(): array {
		return [
			...
			'gmc' => [
				'options'    => [ 'dze_gmc_credentials', 'dze_gmc_accounts', 'dze_gmc_oauth', 'dze_gmc_advanced', 'dze_gmc_connection', 'dze_gmc_datasources' ],
				'transients' => [ 'dze_gmc_oauth_token' ],
			],
			'gmc_activation' => [
			...
			'category_content' => [
				...
				'transients' => [ 'dze_cc_sitemap_v7', 'dze_cc_sitemap_lock', 'dze_cc_pcount_' ],
			],
			'content' => [
				'options'    => [ 'dze_content_settings' ],
				'transients' => [ 'dze_content_bulk_', 'dze_product_meta_keys' ],
			],
			'pod' => [
	...
	public static function core_map(): array {
		return [
			'options' => [ 'dze_modules', 'dze_autoload_trimmed', 'dze_dev_channel', self::OPT_ON_UNINSTALL ],
		];
	}
