...
final class DZE_Cleanup {
	...
	public static function map(): array {
		return [
			...
			'discounts' => [
				'options'    => [ 'dze_discount_rules', 'dze_discount_exclusions', 'dze_sale_sync_queue', 'dze_discount_badge', 'dze_discount_badge_where' ],
			...
			'klaviyo' => [
				...
				'transients' => [ 'dze_klaviyo_cat', 'dze_klaviyo_hours' ],
			],
